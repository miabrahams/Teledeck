...
type ImageScorerClient interface {
	...
	TagUrl(ctx context.Context, in *ImageUrlRequest, opts ...grpc.CallOption) (*TagResult, error)
}
...
func (c *imageScorerClient) TagUrl(ctx context.Context, in *ImageUrlRequest, opts ...grpc.CallOption) (*TagResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TagResult)
...
type ImageScorerServer interface {
	...
	TagUrl(context.Context, *ImageUrlRequest) (*TagResult, error)
...
func (UnimplementedImageScorerServer) TagUrl(context.Context, *ImageUrlRequest) (*TagResult, error) {
...
func _ImageScorer_TagUrl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ImageScorerServer).TagUrl(ctx, req.(*ImageUrlRequest))
	}
	return interceptor(ctx, in, info, handler)
}
